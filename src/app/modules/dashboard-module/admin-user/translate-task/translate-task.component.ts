...
@Component({
  selector: 'app-translate-task',
  templateUrl: './translate-task.component.html',
  styleUrls: ['./translate-task.component.css']
})
export class TranslateTaskComponent implements OnInit {
  ...
  loadTranslationTaskList() {
    ...
    this.taskService.getTranslateTaskList(this.requestParamModel).subscribe((resp: any) => {
